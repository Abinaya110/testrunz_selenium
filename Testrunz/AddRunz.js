...
async function AddRunz() {
    ...
    try {
        ...
        const graphoption2 = await driver.wait(until.elementLocated(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div[2]/div[1]/div/p/div/div/div[1]/div/div[2]/div/span/div/select/option[2]")), 30000);
        ...
        await driver.executeScript('arguments[0].scrollIntoView();', generatebutton);
        await driver.executeScript("arguments[0].click()", generatebutton);
        console.log("generatebutton worked");
       


        const updatebutton = await driver.wait(until.elementLocated(By.xpath("/html/body/div[1]/div/div/div/div[2]/div[2]/div[2]/div[1]/div/p/div/div/div[1]/div/div[2]/div/span/div/button[2]")), 50000);
        await driver.executeScript("arguments[0].click()", updatebutton);
        await driver.wait(until.elementIsVisible(updatebutton), 50000);
